...
class ConnectionPool extends BaseConnectionPool {
  _poolCreate () {
    return new shared.Promise((resolve, reject) => {
      ...
      cfg.options.connectTimeout = this.config.connectionTimeout || this.config.timeout || 30000
      cfg.options.requestTimeout = this.config.requestTimeout != null ? this.config.requestTimeout : 30000
